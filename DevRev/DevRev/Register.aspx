<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="DevRev.Register" %>
...
<body style="background-color:white;" >
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <asp:Label ID="msg" runat="server" Text="" Font-Bold="true" ForeColor="Red" ></asp:Label>
            <br />
            <asp:Button ID="Button1" runat="server" Text="Register" Font-Bold="true" BackColor="DarkViolet" ForeColor="White" OnClick="Button1_Click" />
             <br />
            <div>
